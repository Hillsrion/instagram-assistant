...
export function AnalyticsDashboard() {
  ...
  const [filteredMessageCount, setFilteredMessageCount] = useState<
    number | null
  >(null);
  ...
  const sortedParticipants = Object.entries(participantStats)
    .toSorted(([, a], [, b]) => b.message_count - a.message_count)
    .slice(0, 10);
  ...
  return (
    <div className="h-full overflow-y-auto bg-linear-to-br from-slate-50 to-slate-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">
              {formatDate(analytics.date_start)} —{" "}
              {formatDate(analytics.date_end)}
            </p>
          </div>
        ...
        <div className="mb-8">
          <FiltersPanel
            participants={Object.keys(participantStats).toSorted()}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          {stats.conversations} conversation
                ...
                monthlyData
                  ...
                  .map((data) => {
                    const maxMessages = Math.max(
                      ...monthlyData.map((d) => d.message_count),
                      1,
                    );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li>
                  ...
                  {analytics.total_participants > 0
                    ? Math.round(
                        analytics.total_messages / analytics.total_participants,
                      )
                    : 0}
                </li>
                <li>
                  ...
                  {analytics.total_chunks > 0
                    ? Math.round(
                        analytics.total_messages / analytics.total_chunks,
                      )
                    : 0}
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li>
                  <span className="font-medium">Data indexed:</span>{" "}
                  {analytics.total_chunks} chunks
                </li>
                <li>
