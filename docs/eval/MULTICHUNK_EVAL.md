...
python -m eval.dataset.generate_multichunk_dataset --size 30

# Custom chunk counts
python -m eval.dataset.generate_multichunk_dataset --size 50 --chunks 5,10,15
```
...
python -m eval.generation.eval_generation_multichunk qwen3:latest --trials 10

# Compare multiple models
python -m eval.generation.eval_generation_multichunk qwen3:latest mistral:latest --trials 20

# Generate HTML report with visualizations
python -m eval.generation.eval_generation_multichunk qwen3:latest --trials 10 --html

# Use MLX provider instead of Ollama
python -m eval.generation.eval_generation_multichunk --provider mlx qwen3:latest --trials 10
```
...
└── eval_dataset_multichunk.json       # Generated multi-chunk dataset (root)
```
